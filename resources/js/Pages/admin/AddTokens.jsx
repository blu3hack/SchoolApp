...
function AddUsers() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.put(route("tokens.update", selectedUser.id), data, {
            onSuccess: () => {
    ...
    const handleSearchUsers = (e) => {
        ...
        router.get(
            route("add-tokens"), // route Laravel untuk menampilkan user
