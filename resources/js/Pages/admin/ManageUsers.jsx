...
function ManageUsers() {
    ...
    const handleSearchUsers = (e) => {
        ...
        router.get(
            route("manage-user"), // route Laravel untuk menampilkan user
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {users.map((user) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-8 py-6 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className="h-12 w-12 flex-shrink-0">
                                                    <div className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                                        ...
                                        <td className="px-8 py-6 whitespace-nowrap">
                                            <span
                                                className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold shadow-sm ${getRoleBadgeColor(
                                                    user.role
                                                )}`}
                                            >
                                                {user.role || "No Role"}
